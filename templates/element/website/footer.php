                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="modal-product-img">
                                            <img src="<?= $this->Url->build('/') ?>assets/img/drugs/abab1a68-e03c-494a-aaf2-ad0d9f7830a3.jpeg" alt="#">
                                        </div>
                         ...
                         <div class="ltn__quick-view-modal-inner">
                             <div class="modal-product-item">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="modal-product-img">
                                            <img src="<?= $this->Url->build('/') ?>assets/img/drugs/da7cfb98-a409-4832-9e3a-c0e33ed36c57.jpeg" alt="#">
                                        </div>
                                         <div class="modal-product-info">
                                            <h5><a href="#">Digital Stethoscope</a></h5>
