...
<div class="card-body p-24">
    ...
    <div class="col-xl-8 col-lg-10">
        ...
        <div class="card-body">
        <?= $this->Form->create($innerCategory, ['type' => 'file']) ?>
            <fieldset>
                <legend><?= __(' تحديث تصنيف فرعي') ?></legend>

                <div class="mb-20">
                    <label for="name" class="form-label fw-semibold text-primary-light text-sm mb-8"> أسم التصنيف الفرعي <span class="text-danger-600">*</span></label>
                ...
                <div class="mb-20">
                    <label for="name" class="form-label fw-semibold text-primary-light text-sm mb-8"> أسم التصنيف الرئيسي <span class="text-danger-600">*</span></label>
                        <?= $this->Form->control('category_id', [ 'options' => $categories, 'empty' => true ,'label'=>false,'class' => 'form-control radius-8',  "placeholder"=>"ادخل الاسم", 'error' => ['class' => 'text-danger']  ]) ?>
                </div>
                ...
                <label for="photo" class="form-label fw-semibold text-primary-light text-sm mb-8">   الصورة <span class="text-danger-600">*</span></label>
                    <div class="upload-image-wrapper">
                        <div style="text-align: center;" class="uploaded-img position-relative h-160-px w-100 border input-form-light radius-8 overflow-hidden border-dashed bg-neutral-50">
                            ...
                            <img id="uploaded-img__preview" style="      object-fit: contain !important;  width: 150px !important;height: 125px !important;" class="w-100 h-100 object-fit-cover" src="<?= $this->Url->build('/').$innerCategory["photo"] ?>" alt="image">
                        </div>
