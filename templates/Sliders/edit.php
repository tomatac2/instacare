                                  ...
                                  <legend><?= __(' تحديث سيلدير') ?></legend>
                                    <div class="mb-20">
                                        <label for="name" class="form-label fw-semibold text-primary-light text-sm mb-8"> أسم السيلدير  <span class="text-danger-600">*</span></label>
                                         <?= $this->Form->control('name', [ 'type'=>'text','label'=>false,'class' => 'form-control radius-8',  "placeholder"=>"ادخل الاسم", 'error' => ['class' => 'text-danger']  ]) ?>
                                    </div>
                         
                                    <div class="mb-20">
                                        <label for="link" class="form-label fw-semibold text-primary-light text-sm mb-8"> اللينك  <span class="text-danger-600">*</span></label>
                                         <?= $this->Form->control('link', [ 'name'=>'link','type'=>'text','label'=>false,'class' => 'form-control radius-8',  "placeholder"=>"ادخل اللينك", 'error' => ['class' => 'text-danger']  ]) ?>
                                    </div>
                                    ...
                                    <div class="mb-20">
                                        <label for="link" class="form-label fw-semibold text-primary-light text-sm mb-8"> نوع السيلدير  <span class="text-danger-600">*</span></label>
                                         <?= $this->Form->control('type', ['name'=>'type','type'=>'select', 'value'=>$slider["type"] ,"options"=>["رئيسي"=>"رئيسي","فرعي"=>"فرعي"], 'label'=>false,'class' => 'form-select form-control radius-8',  'error' => ['class' => 'text-danger']  ]) ?>
                                    </div>
