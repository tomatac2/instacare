    ...
    <div class="card-body p-24">
        ...
        <div class="column column-80">
              <div class="card-body card">
                <?= $this->Form->create($brand, ['type' => 'file']) ?>
                    <legend><?= __('إضافة علامة تجارية ') ?></legend>
                    ...
                    <div class="mb-20">
                        <label for="name" class="form-label fw-semibold text-primary-light text-sm mb-8"> أسم التصنيف الرئيسي <span class="text-danger-600">*</span></label>
                            <?= $this->Form->control('name', [ 'label'=>false,'class' => 'form-control radius-8',  "placeholder"=>"ادخل الاسم" ,'required' => false, 'error' => ['class' => 'text-danger']  ]) ?>
                    </div>
                    <div>
                        ...
                        <div class="upload-image-wrapper">
                            <div  style="text-align: center;" class="uploaded-img d-none position-relative h-160-px w-100 border input-form-light radius-8 overflow-hidden border-dashed bg-neutral-50">
                                ...
                                <img id="uploaded-img__preview" style="object-fit: contain !important;  width: 150px !important;height: 125px !important;"  class="w-100 h-100 object-fit-cover" src="<?= $this->Url->build('/') ?>dashboard/assets/images/user.png" alt="image">
                            </div>
